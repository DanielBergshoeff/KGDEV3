...
public class GeneticAlgorithm<T> {
    ...
    public GeneticAlgorithm(int populationSize, int dnaSize, Random random, Func<T> getRandomGene, Func<int, float> fitnessFunction, int Elitism = 0, float mutationRate = 0.01f) {
        Generation = 1;
